...
def generate_images(model,test_input,t,a,b):
  images_dir = './output images/E' + str(EPOCHS) + 'B' + str(BATCH_SIZE)
...
def Accuracy():
  ...
  acc=0
  for dataset in test_dataset_1.take(test_dataset_size/BATCH_SIZE):
  ...
  tf.print("Mean Accuracy: ",(acc/test_dataset_size)*BATCH_SIZE)
