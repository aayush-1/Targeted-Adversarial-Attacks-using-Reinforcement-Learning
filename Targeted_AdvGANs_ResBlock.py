...
def ResBlock(filters, size, stride=2, apply_batchnorm=True):
  initializer = tf.random_normal_initializer(0., 0.02)
...
def Generator():
  ...
  down_stack = [
    downsample(8, 3,1), # (bs, 128, 128, 64)
    downsample(16, 3, 2), # (bs, 64, 64, 128)
    downsample(32, 3,stride=2) # (bs, 32, 32, 256)
    ]
  res_stack = [
  ResBlock(32,3,1),
  ResBlock(32,3,1),
